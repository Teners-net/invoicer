...
const SecondaryInput = forwardRef(({
  ...
  return (
    <div>
      <label htmlFor={id ?? name} className={`md:mt-1 p flex justify-start items-start gap-4 p-3 bg-gray-50 dark:bg-gray-950 border md:border-2 ${(error && touched) && 'border-red-500'} ${wrapperStyle}`}>
